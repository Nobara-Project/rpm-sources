%if 0%{?rhel} == 7
%global _dracutopts_in  nouveau.modeset=0 rd.driver.blacklist=nouveau modprobe.blacklist=nouveau nofb
%global _dracutopts_rm  nomodeset gfxpayload=vga=normal nvidia-drm.modeset=1 nvidia-drm.fbdev=1 nvidia-drm.
...
%global _dracutopts_rm  rd.driver.blacklist=nouveau modprobe.blacklist=nouveau nomodeset gfxpayload=vga=normal nouveau.modeset=0 nvidia-drm.modeset=1 nvidia-drm.fbdev=1 nvidia-drm. initcall_blacklist=simpledrm_platform_driver_init
%global _dracut_conf_d  %{_prefix}/lib/dracut/dracut.conf.d
%global _grubby         %{_sbindir}/grubby --update-kernel=ALL
%endif
...
%changelog
* Thu Dec 21 2023 Simone Caronni <negativo17@gmail.com> - 3:545.29.06-2
- Add support for Kickstart installations and systemd-boot.
