...
BuildArch:      noarch
# Disable until cachy updates
#Source0:        https://github.com/CachyOS/open-gpu-kernel-modules/archive/refs/heads/%{major_version}-cachyos.tar.gz
...
Patch1:         0003-fix-dsc-correct-RC-parameter-tables-to-match-VESA-DS.patch
Patch2:         0004-fix-dsc-use-bits_per_component-for-flatnessDetThresh.patch
Patch3:         0005-fix-dp-add-Bigscreen-Beyond-VR-headset-to-WAR-databa.patch
