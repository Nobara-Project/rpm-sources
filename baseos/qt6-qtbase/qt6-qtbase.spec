...
# fix Ampersands in widget titles
# Issue
...
# Fix example from similar issue:
# https://github.com/qt/qtbase/commit/cc67b25579c1bb5ea9f5c1ca4c9b7997e66f19b9
# OBS-studio uses style sheets and the issue only occurs in dock widget titles, so..
Patch59: 0001-fix-underlined-text-in-dock-widget-titles-rendering-.patch
