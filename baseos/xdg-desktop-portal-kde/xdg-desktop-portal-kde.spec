...
# 6.0.5: Fix screencast window restoration check
# https://invent.kde.org/plasma/xdg-desktop-portal-kde/-/merge_requests/290
# Will be fixed in 6.1
Patch0:         6.0.5-fix-screencast-window-restoration-check.patch

# needed for steam deck control passthrough
Patch1:         279.patch
Patch2:         283.patch
Patch3:         313c86877db027c7f4d7b3e794123149f5618613.patch
...
%changelog
* Wed Jun 05 2024 Steve Cossette <farchord@gmail.com> - 6.0.5-2
