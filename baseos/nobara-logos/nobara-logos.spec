...
%package httpd
Summary:	Nobara-related icons and pictures used by httpd
...
touch watermark.png
install -p -m 644 watermark.png $RPM_BUILD_ROOT%{_datadir}/plymouth/themes/spinner/watermark.png
...
cp -a nobara/*.svg $RPM_BUILD_ROOT%{_datadir}/%{name}
