...
mainline 7.2, production 595.91.07 and beta 595.45.04; historical source
...
The package's post-transaction script regenerates existing initramfs images;
subsequent kernel-install builds inherit the same policy. An upgrade removes
