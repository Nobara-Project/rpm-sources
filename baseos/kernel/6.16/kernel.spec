...
# Logitech wheel
Patch6: ps-logitech-wheel.patch
# give kernel taint warning when amdgpu power controls are enabled
Patch7: amdgpu.ppfeaturemask-taint_warning.patch
# fixes framerate control in gamescope
Patch8: valve-gamescope-framerate-control-fixups.patch
# fixes orientation on SuiPlay0X1
Patch9: suiplay0x1-orientation-quirk.patch
# fixes headphones on various Aya Neo devices
Patch10: ayaneo-headset-fix.patch
