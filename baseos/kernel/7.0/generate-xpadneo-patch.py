...
def generate_patch(kernel_version):
    ...
    kernel_dir = script_dir / f"linux-cachyos-{kernel_version}"
    ...
    print()
    print("No additional udev rules are required.")
    print("Controller input and rumble are accessible via systemd's built-in joystick")
    print("uaccess rules (ID_INPUT_JOYSTICK). hidraw access for Steam Input is provided")
    print("by /usr/lib/udev/rules.d/60-steam-input.rules, shipped with Steam.")
    print()
