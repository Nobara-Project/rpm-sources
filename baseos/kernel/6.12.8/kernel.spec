...
# fix for some controllers (e.g. DualSense) not properly being assigned permissions via udev rules
Patch312: uinput.patch

# CachyOS: https://github.com/CachyOS/kernel-patches
Patch400: 0008-ntsync.patch
Patch401: 0002-amd-pstate.patch
Patch402: 0001-zenify.patch
Patch403: 0001-bore.patch
# give kernel taint warning when amdgpu power controls are enabled
Patch404: amdgpu.ppfeaturemask-taint_warning.patch
...
Patch600: amdgpu-HAINAN-variant-fixup.patch
Patch601: 0001-Revert-PCI-Add-a-REBAR-size-quirk-for-Sapphire-RX-56.patch
# https://lore.kernel.org/all/d0306912-e88e-4c25-8b5d-545ae8834c0c@gmail.com/
Patch602: add-RTL8125D.patch
...
ApplyOptionalPatch add-RTL8125D.patch
