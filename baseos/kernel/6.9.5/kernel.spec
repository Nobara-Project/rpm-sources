...
# t2/surface patch conflict resolution
# omit for now
# Patch1008: t2-surface-hid-multitouch.patch
...
# ApplyOptionalPatch t2-surface-hid-multitouch.patch
