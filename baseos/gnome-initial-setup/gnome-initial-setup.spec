...
* Tue Sep 12 2023 Michael Catanzaro <mcatanzaro@redhat.com> - 45~beta-25
- Reverted all downstream F39 changes to gnome-initial-setup

* Tue Sep 12 2023 Michael Catanzaro <mcatanzaro@redhat.com> - 45~beta-24
- Revert "Add liveuser mode and switch vendor.conf to accomodate it"

* Tue Sep 12 2023 Michael Catanzaro <mcatanzaro@redhat.com> - 45~beta-23
- Revert "Add keyboard and input method handling fixes"

* Tue Sep 12 2023 Michael Catanzaro <mcatanzaro@redhat.com> - 45~beta-22
- Revert "Clean up gnome-desktop requires"

* Tue Sep 12 2023 Michael Catanzaro <mcatanzaro@redhat.com> - 45~beta-21
- Revert "Update to use slightly tweaked default input sources api from
  gnome-desktop"

* Tue Sep 12 2023 Michael Catanzaro <mcatanzaro@redhat.com> - 45~beta-20
- Revert "More keyboard configuration updates"

* Tue Sep 12 2023 Michael Catanzaro <mcatanzaro@redhat.com> - 45~beta-19
- Revert "Fix keyboard page next button that can't be buttoned"

* Tue Sep 12 2023 Michael Catanzaro <mcatanzaro@redhat.com> - 45~beta-18
- Revert "Don't let language page proceed until it has committed its
  changes"

* Tue Sep 12 2023 Michael Catanzaro <mcatanzaro@redhat.com> - 45~beta-17
- Revert "drop unused patches"

* Tue Sep 12 2023 Michael Catanzaro <mcatanzaro@redhat.com> - 45~beta-16
- Revert "Select US by default on Russian keyboards"

* Tue Sep 12 2023 Michael Catanzaro <mcatanzaro@redhat.com> - 45~beta-15
- Revert "Add missing patches"

* Tue Sep 12 2023 Michael Catanzaro <mcatanzaro@redhat.com> - 45~beta-14
