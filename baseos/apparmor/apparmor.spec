...
%make_install -C parser \
    ...
    SBINDIR=%{buildroot}%{_custom_sbin}
...
%{_custom_sbin}/aa-audit
%{_custom_sbin}/aa-autodep
%{_custom_sbin}/aa-cleanprof
%{_custom_sbin}/aa-complain
%{_custom_sbin}/aa-decode
%{_custom_sbin}/aa-disable
%{_custom_sbin}/aa-enforce
%{_custom_sbin}/aa-genprof
%{_custom_sbin}/aa-logprof
%{_custom_sbin}/aa-mergeprof
%{_custom_sbin}/aa-notify
%{_custom_sbin}/aa-remove-unknown
%{_custom_sbin}/aa-status
%{_custom_sbin}/aa-unconfined
%{_custom_sbin}/apparmor_status
%{_custom_sbin}/aa-load
%{_custom_sbin}/aa-teardown
%{_bindir}/aa-easyprof
%dir %{_datadir}/apparmor
...
%changelog
* Sun Nov 24 2019 gasinvein <gasinvein@gmail.com> - 2.13.3-0.2
- Backport makefile patch, pass dirs via vars
- Add systemd preset enabling apparmor.service

* Sat Jul 27 2019 gasinvein <gasinvein@gmail.com>
- Initial package
