...
# Examples: gcc.spec
%global dist_bug_report_url https://github.com/nobara-project/nobara-images

# debuginfod server, as used in elfutils.spec.
%global dist_debuginfod_url https://github.com/nobara-project/nobara-images
# -------------------------------------------------------------------------
