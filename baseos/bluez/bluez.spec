...
%endif
           ...
           --enable-csip --enable-vcp --enable-btpclient \
           --enable-midi \
...
cp %{SOURCE1} %{buildroot}/usr/lib/modprobe.d/bluetooth-usb.conf
echo "crypto_user" > %{buildroot}/usr/lib/modules-load.d/bluez.conf
install -Dm644 plugins/wake-policy.conf %{buildroot}/etc/bluetooth/wake-policy.conf
...
%{_sysconfdir}/bluetooth/wake-policy.conf
