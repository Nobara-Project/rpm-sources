...
# Nobara addons
Patch7:        enable-window-centering.patch
Patch8:	       mutter_increase_check_alive_timeout.patch

# Enable Fractional Scaling
Patch9:	       enable-fractional-scaling.patch

# Helps with nvidia multimonitor
# https://gitlab.gnome.org/GNOME/mutter/-/merge_requests/3304
Patch10:       3304.patch

# Needed for nvidia on wayland
# https://gitlab.gnome.org/GNOME/mutter/-/merge_requests/3340
Patch11:       3340.patch

# https://gitlab.gnome.org/GNOME/mutter/-/merge_requests/3139
Patch12:       3139.patch
...
* Sun Apr 21 2024 Florian Müllner <fmuellner@redhat.com> - 45.6-1
- Update to 45.6

* Sat Mar 16 2024 Florian Müllner <fmuellner@redhat.com> - 45.5-1
- Update to 45.5

* Sun Feb 11 2024 Florian Müllner <fmuellner@gnome.org> - 45.4-1
- Update to 45.4

* Sun Jan 07 2024 Florian Müllner <fmuellner@gnome.org> - 45.3-1
- Update to 45.3
...
* Mon Oct 30 2023 Adam Williamson <awilliam@redhat.com> - 45.0-12
- Backport MRs #3311 and #3326 to fix screencast issues (#2247033)

* Tue Oct 24 2023 Adam Williamson <awilliam@redhat.com> - 45.0-11
- Update the #3329 backport with jadahl's proposed fix

* Fri Oct 20 2023 Kalev Lember <klember@redhat.com> - 45.0-10
- Backport upstream MR3329 to fix black screen in the installer (#2241632)

* Wed Oct 11 2023 Ray Strode <rstrode@redhat.com> - 45.0-9
- Update realtime-disabling patch to latest upstream revision

* Tue Oct 10 2023 Ray Strode <rstrode@redhat.com> - 45.0-8
- Disable realtime scheduling during modesets (#2240457)

* Fri Oct 06 2023 Adam Williamson <awilliam@redhat.com> - 45.0-7
- Revert a change to fix installer window interaction

* Fri Oct 06 2023 Adam Williamson <awilliam@redhat.com> - 45.0-6
- Don't number patches, it's no longer necessary and it's a lot simpler not
  to.

* Wed Oct 04 2023 Kalev Lember <klember@redhat.com> - 45.0-5
- Backport upstream MR3306 to fix issues with caps lock and accented
  letters

* Wed Oct 04 2023 Kalev Lember <klember@redhat.com> - 45.0-4
- Backport upstream MR3299 to fix disabling scale-monitor-framebuffer

* Tue Sep 26 2023 Michael Catanzaro <mcatanzaro@redhat.com> - 45.0-3
- Revert framebuffer scaling patch

* Sat Sep 16 2023 Florian Müllner <fmuellner@gnome.org> - 45.0-2
...
* Mon Sep 04 2023 Jonas Ådahl <jadahl@gmail.com> - 45~beta.1-4
...
* Thu Aug 17 2023 Joshua Strobl <me@joshuastrobl.com> - 45~beta.1-2
