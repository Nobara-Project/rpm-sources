...
Source0:         https://gitlab.gnome.org/World/gedit/%{name}/-/archive/%{version}/%{name}-%{version}.tar.bz2
# libgd is a git submodule by design, but those are not included in git forge snapshot tarballs
Source1:         https://gitlab.gnome.org/GNOME/libgd/-/archive/%{libgd_commit}/libgd-%{libgd_commit}.tar.bz2
...
* Wed Jul 23 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2:48.2-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Thu May 01 2025 Yaakov Selkowitz <yselkowi@redhat.com> - 2:48.2-1
- Update to 48.2

* Sun Mar 30 2025 Yaakov Selkowitz <yselkowi@redhat.com> - 2:48.1-1
- Update to 48.1

* Thu Jan 16 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2:46.2-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Wed Aug 28 2024 Miroslav Suchý <msuchy@redhat.com> - 2:46.2-5
- convert license to SPDX

* Mon Aug 26 2024 David King <amigadave@amigadave.com> - 2:46.2-4
- Rebuild against gspell

* Thu Jul 18 2024 Fedora Release Engineering <releng@fedoraproject.org> - 2:46.2-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Fri Jun 07 2024 Python Maint <python-maint@redhat.com> - 2:46.2-2
- Rebuilt for Python 3.13

* Thu Apr 04 2024 Nieves Montero <nmontero@redhat.com> - 2:46.2-1
- Update to 46.2

* Sun Jan 28 2024 Yaakov Selkowitz <yselkowi@redhat.com> - 2:46.1-1
- Update to 46.1

* Wed Jan 24 2024 Fedora Release Engineering <releng@fedoraproject.org> - 2:45.0-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_40_Mass_Rebuild

* Fri Jan 19 2024 Fedora Release Engineering <releng@fedoraproject.org> - 2:45.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_40_Mass_Rebuild
...
* Fri May 27 2022 David King <amigadave@amigadave.com> - 2:42.1-1
- Update to 42.1
...
* Fri Jun 04 2021 Python Maint <python-maint@redhat.com> - 2:40.1-2
- Rebuilt for Python 3.10

* Mon Apr 19 2021 Kalev Lember <klember@redhat.com> - 2:40.1-1
- Update to 40.1
