...
# Pull in the noarch package-name shim. The versioned requirement cannot be
# self-satisfied by the lower-versioned zlib compatibility provide above.
...
%package -n zlib
Summary:	Zlib package-name compatibility for %{name}
BuildArch:	noarch
Requires:	%{name}-compat = %{version}-%{release}

%description -n zlib
This package preserves the traditional zlib RPM package name for third-party
installers that query package names directly. The actual zlib-compatible
library is provided by %{name}-compat.
...
%changelog
* Tue Aug 25 2026 GloriousEggroll <gloriouseggroll@gmail.com> - 2.3.3-4.nobara
- Add a real noarch zlib package-name shim for third-party installers
- Keep the zlib-compatible library payload in zlib-ng-compat
