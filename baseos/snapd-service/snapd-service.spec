...
Source0:        https://%{provider_prefix}/releases/download/%{version}/snapd_%{version}.no-vendor.tar.xz
Source1:        https://%{provider_prefix}/releases/download/%{version}/snapd_%{version}.only-vendor.tar.xz
...
Provides:       snapd-login-service%{?_isa} = 1.33
%endif
...
Summary:         Unit tests for snapd package
...
Requires:        snapd-devel = %{version}-%{release}
