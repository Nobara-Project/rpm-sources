...
# Make an update-grub alias for ubuntu newcomers
cat << EOF >> ${RPM_BUILD_ROOT}/%{_sbindir}/update-grub
/usr/sbin/grub2-mkconfig -o /boot/grub2/grub.cfg
EOF
chmod 755 ${RPM_BUILD_ROOT}/%{_sbindir}/update-grub
ln -s %{_sbindir}/update-grub ${RPM_BUILD_ROOT}/%{_sbindir}/update-grub2
...
%attr(4755, root, root) %{_sbindir}/update-grub
...
* Fri Apr 10 2026 Leo Sandoval <lsandova@redhat.com> - 2.12-57
- Move the EFI config's stub generation into EFI posttrans
- Resolves: #2457071

* Wed Apr 08 2026 Leo Sandoval <lsandova@redhat.com> - 2.12-56
...
* Fri Mar 20 2026 Peter Jones <pjones@redhat.com> - 2.12-55
- Kick off another build to test nirik's work on the builders.

* Wed Mar 18 2026 Josue Hernandez <josherna@redhat.com> - 2.12-54
