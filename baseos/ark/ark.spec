...
# Fix partial extraction dropping empty directories.
# https://bugs.kde.org/show_bug.cgi?id=524702
Patch0: 0001-libarchive-Preserve-empty-directories-during-partial.patch
...
%changelog
* Mon Aug 24 2026 GloriousEggroll <gloriouseggroll@gmail.com> - 26.08.0-2
- Fix partial extraction dropping empty directories (KDE bug 524702)
