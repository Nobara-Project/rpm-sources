...
Source0:        https://gitlab.freedesktop.org/hadess/switcheroo-control/-/releases/%{version}/downloads/switcheroo-control-%{version}.tar.xz
...
%changelog
* Sun Sep 07 2025 LionHeartP <LionHeartP@proton.me> - 3.0-1
- Update to 3.0
- Remove 69.patch (merged upstream)
