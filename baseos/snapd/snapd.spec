...
# We need to add Nobara to the altdir distro list in the directories configuration. If not, we end up with this:

# Fedora build version `snap debug paths`:
#$ snap debug paths
#SNAPD_MOUNT=/var/lib/snapd/snap
#SNAPD_BIN=/var/lib/snapd/snap/bin
#SNAPD_LIBEXEC=/usr/libexec/snapd

# Nobara build version `snap debug paths`:
#$ snap debug paths
#SNAPD_MOUNT=/snap
#SNAPD_BIN=/snap/bin
#SNAPD_LIBEXEC=/usr/lib/snapd

Patch1:         0001-add-nobara-to-fedora-like-alt-directories-list-and-t.patch
...
# Ensure /var/lib/snapd/snap is a symlink to /snap for classic snap support
ln -sf %{_sharedstatedir}/snapd/snap %{buildroot}/snap
